...
A:ส่วนใหญ่ถ้าลงเป็น RDP จะไม่มีไดร์เวอร์เสียงอยู่แล้ว แนะนำติดตั้ง [VB-Cable](https://vb-audio.com/Cable/index.htm) เพื่อให้ไดเวอร์เสียงทำงาน จากนั้นรีสตาร์ท หากใช้ระบบปฏิบัติการ Linux ไม่จำเป็นต้องติดตั้งไดร์เวอร์เสียง โดยส่วนใหญ่เสียงที่ได้ยินจะมาจาก Remote Desktop เท่านั้น
